...
df_participants <- readRDS("data/output/df_participants_S4.rds")

# sd questions LONG (with pre/post in sep cols)
df_questions_long <- readRDS("data/output/df_questions_long_S4.rds")

# all questions LONG
df_graphs <- readRDS("data/output/df_graphs_S4.rds")
...
# MOCKUP (FIG 1) MAIN DESCRIPTIVES FIGURE (QUESTIONS + BLOCK 1)
## BLOCK 1 BY SAMPLE
...
df <- df_questions_long %>% filter(QUESTION %in% ref_sd_questions)
