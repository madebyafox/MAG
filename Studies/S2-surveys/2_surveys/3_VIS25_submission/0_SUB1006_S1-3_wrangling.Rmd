...
## WRITE DATAFRAME
write.csv(df_questions, file = "data/output/Study_1_2_3/df_questions.csv", na="")
saveRDS(df_questions, file = "data/output/Study_1_2_3/df_questions.rds")
```
...
df_sd_questions_long_z <- df_graphs_z %>% 
  ...
  mutate(
    ...
    CHART_INTENT = as.numeric(CHART_INTENT),
    CHART_TRUST = as.numeric(CHART_TRUST),
    MAKER_CONF = as.numeric(MAKER_CONF),
    AGE_CONF = as.numeric(AGE_CONF),
    GENDER_CONF = as.numeric(GENDER_CONF),
    TOOL_CONF = as.numeric(TOOL_CONF)
  ) %>% 
