...
`df_questions` is at the graph-question level, but includes _all_ questions, both categorical, free response, and numeric. 
...
Note: created as separate files rather than adding cols to 
