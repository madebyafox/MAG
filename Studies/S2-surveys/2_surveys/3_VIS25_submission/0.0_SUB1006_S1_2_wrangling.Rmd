---
title: "S1-2 DATA WRANGLING—SUBMISSION 1006"
author: "ANONYMIZED"
date: "2025-02-24"
output:
  html_document:
...
write.csv(df_exclude, file = "data/output/Study_1_2/df_exclude.csv", na="")
saveRDS(df_exclude, file = "data/output/Study_1_2/df_exclude.rds")
...
write.csv(df_data, file = "data/output/Study_1_2/df_data.csv", na="")
saveRDS(df_data, file = "data/output/Study_1_2/df_data.rds")
...
write.csv(df_participants, file = "data/output/Study_1_2/df_participants.csv", na="")
saveRDS(df_participants, file = "data/output/Study_1_2/df_participants.rds")
...
df_qda_wide <- df_data
write.csv(df_data, file = "data/output/Study_1_2/df_qda_wide.csv", na="")
...
write.csv(df_qda_long, file = "data/output/Study_1_2/df_qda_long.csv", na="")
...
## WRITE DATAFRAME
write.csv(df_questions, file = "data/output/Study_1_2/df_questions_long.csv", na="")
saveRDS(df_questions, file = "data/output/Study_1_2/df_questions_long.rds")
```
...
## WRITE DATAFRAME
write.csv(df_sd_questions_long, file = "data/output/Study_1_2/df_sd_questions_long.csv", na="")
saveRDS(df_sd_questions_long, file = "data/output/Study_1_2/df_sd_questions_long.rds")
...
## WRITE DATAFRAME
write.csv(df_sd_questions_wide, file = "data/output/Study_1_2/df_sd_questions_wide.csv", na="")
saveRDS(df_sd_questions_wide, file = "data/output/Study_1_2/df_sd_questions_wide.rds")
```
...
## WRITE DATAFRAME
write.csv(df_tools, file = "data/output/Study_1_2/df_tools.csv", na="")
saveRDS(df_tools, file = "data/output/Study_1_2/df_tools.rds")
```
...
## WRITE DATAFRAME
write.csv(df_actions, file = "data/output/Study_1_2/df_actions.csv", na="")
saveRDS(df_actions, file = "data/output/Study_1_2/df_actions.rds")
```
...
## WRITE DATAFRAME
write.csv(df_graphs_full, file = "data/output/Study_1_2/df_graphs_full.csv", na="")
saveRDS(df_graphs_full, file = "data/output/Study_1_2/df_graphs_full.rds")
...
## WRITE DATAFRAME
write.csv(df_graphs, file = "data/output/Study_1_2/df_graphs.csv", na="")
saveRDS(df_graphs, file = "data/output/Study_1_2/df_graphs.rds")
...
write.csv(df_graphs_z, file = "data/output/Study_1_2/df_graphs_z.csv", na="")
saveRDS(df_graphs_z, file = "data/output/Study_1_2/df_graphs_z.rds")
...
write.csv(df_sd_questions_long_z, file = "data/output/Study_1_2/df_sd_questions_long_z.csv", na="")
saveRDS(df_sd_questions_long_z, file = "data/output/Study_1_2/df_sd_questions_long_z.rds")    
...
write.csv(df_graphs_abs, file = "data/output/Study_1_2/df_graphs_abs.csv", na="")
saveRDS(df_graphs_abs, file = "data/output/Study_1_2/df_graphs_abs.rds")
...
write.csv(df_sd_questions_long_abs, file = "data/output/Study_1_2/df_sd_questions_long_abs.csv", na="")
saveRDS(df_sd_questions_long_abs, file = "data/output/Study_1_2/df_sd_questions_long_abs.rds")    
