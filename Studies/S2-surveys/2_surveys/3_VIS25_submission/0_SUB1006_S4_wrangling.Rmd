...
This notebook takes a raw data files from (1) Qualtrics surveys (Study 4), standardizing the format for further data analysis consistent with the data structures for Studies 1-3. Note that all raw data comes from Qualtrics, and each Qualtrics survey includes a different stimulus block (set of 5 stimuli).
...
write.csv(ref_labels, file = "data/input/REFERENCE/ref_labels_S4.csv", na="")
saveRDS(ref_labels, file = "data/input/REFERENCE/ref_labels_S4.rds")
...
write.csv(ref_labels_abs, file = "data/input/REFERENCE/ref_labels_abs_S4.csv", na="")
saveRDS(ref_labels_abs, file = "data/input/REFERENCE/ref_labels_abs_S4.rds")
...
# 1 row per subject 
df_raw_study4 <- read_csv("data/input/CLEAN/CLEAN_MAG_S2_PROLIFIC_GENERAL_1_STUDY4_PREPOST.csv", col_names = TRUE)

# drop first two rows (these are qualtrics_specs rows)
df_raw_study4 <- df_raw_study4[-c(1:2),]

# RETROFIT SOME COLNAMES FOR COMPATIBILITY WITH TUMBLR 
df_raw_study4 <- df_raw_study4 %>% 
...
write.csv(df_exclude, file = "data/output/Study_4/df_exclude_S4.csv", na="")
saveRDS(df_exclude, file = "data/output/Study_4/df_exclude_S4.rds")
...
write.csv(df_data, file = "data/output/Study_4/df_data_S4.csv", na="")
saveRDS(df_data, file = "data/output/Study_4/df_data_S4.rds")
...
write.csv(df_participants, file = "data/output/Study_4/df_participants_S4.csv", na="")
saveRDS(df_participants, file = "data/output/Study_4/df_participants_S4.rds")
...
## 1 ROW / PARTICIPANT 
df_qda_wide <- df_data
write.csv(df_data, file = "data/output/Study_4/df_qda_wide_S4.csv", na="")
...
write.csv(df_qda_long, file = "data/output/Study_4/df_qda_long_S4.csv", na="")
...
## WRITE DATAFRAME
write.csv(df_questions_long, file = "data/output/Study_4/df_questions_long_S4.csv", na="")
saveRDS(df_questions_long, file = "data/output/Study_4/df_questions_long_S4.rds")
...
## WRITE DATAFRAME
write.csv(df_questions, file = "data/output/Study_4/df_questions_S4.csv", na="")
saveRDS(df_questions, file = "data/output/Study_4/df_questions_S4.rds")
```
...
## WRITE DATAFRAME
write.csv(df_sd_questions_long, file = "data/output/Study_4/df_sd_questions_long_S4.csv", na="")
saveRDS(df_sd_questions_long, file = "data/output/Study_4/df_sd_questions_long_S4.rds")
...
## WRITE DATAFRAME
write.csv(df_sd_questions_wide, file = "data/output/Study_4/df_sd_questions_wide_S4.csv", na="")
saveRDS(df_sd_questions_wide, file = "data/output/Study_4/df_sd_questions_wide_S4.rds")
...
## WRITE DATAFRAME
write.csv(df_graphs_full, file = "data/output/Study_4/df_graphs_full_S4.csv", na="")
saveRDS(df_graphs_full, file = "data/output/Study_4/df_graphs_full_S4.rds")
```
...
## WRITE DATAFRAME
write.csv(df_graphs, file = "data/output/Study_4/df_graphs_S4.csv", na="")
saveRDS(df_graphs, file = "data/output/Study_4/df_graphs_S4.rds")
...
df_graphs_z <- df_graphs %>% 
  mutate(
    PRE_DESIGN  = datawizard::standardize(PRE_DESIGN),
    PRE_DATA = datawizard::standardize(PRE_DATA),
    PRE_POLITICS = datawizard::standardize(PRE_POLITICS),
    PRE_TRUST = datawizard::standardize(PRE_TRUST),
    PRE_ALIGN = datawizard::standardize(PRE_ALIGN),
    PRE_BEAUTY = datawizard::standardize(PRE_BEAUTY),
    PRE_INTENT = datawizard::standardize(PRE_INTENT),
    PRE_LATENCY = datawizard::standardize(PRE_LATENCY),
    PRE_ID_CONF = datawizard::standardize(PRE_ID_CONF),
    PRE_AGE_CONF = datawizard::standardize(PRE_AGE_CONF),
    PRE_GENDER_CONF = datawizard::standardize(PRE_GENDER_CONF),
    POST_DESIGN  = datawizard::standardize(POST_DESIGN),
    POST_DATA = datawizard::standardize(POST_DATA),
    POST_POLITICS = datawizard::standardize(POST_POLITICS),
    POST_TRUST = datawizard::standardize(POST_TRUST),
    POST_ALIGN = datawizard::standardize(POST_ALIGN),
    POST_BEAUTY = datawizard::standardize(POST_BEAUTY),
    POST_INTENT = datawizard::standardize(POST_INTENT),
    POST_LATENCY = datawizard::standardize(POST_LATENCY),
    POST_ID_CONF = datawizard::standardize(POST_ID_CONF),
    POST_AGE_CONF = datawizard::standardize(POST_AGE_CONF),
    POST_GENDER_CONF = datawizard::standardize(POST_GENDER_CONF)
  )
write.csv(df_graphs_z, file = "data/output/Study_4/df_graphs_z_S4.csv", na="")
saveRDS(df_graphs_z, file = "data/output/Study_4/df_graphs_z_S4.rds")
...
df_sd_questions_long_z <- df_graphs_z %>% 
  ...
  mutate(
    PRE_DESIGN = as.numeric(PRE_DESIGN),
    PRE_DATA = as.numeric(PRE_DATA),
    PRE_POLITICS = as.numeric(PRE_POLITICS),
    PRE_TRUST = as.numeric(PRE_TRUST),
    PRE_ALIGN = as.numeric(PRE_ALIGN),
    PRE_BEAUTY = as.numeric(PRE_BEAUTY),
    PRE_INTENT = as.numeric(PRE_INTENT),
    PRE_LATENCY = as.numeric(PRE_LATENCY),
    PRE_ID_CONF = as.numeric(PRE_ID_CONF),
    PRE_AGE_CONF = as.numeric(PRE_AGE_CONF),
    PRE_GENDER_CONF = as.numeric(PRE_GENDER_CONF),
    POST_DESIGN = as.numeric(POST_DESIGN),
    POST_DATA = as.numeric(POST_DATA),
    POST_POLITICS = as.numeric(POST_POLITICS),
    POST_TRUST = as.numeric(POST_TRUST),
    POST_ALIGN = as.numeric(POST_ALIGN),
    POST_BEAUTY = as.numeric(POST_BEAUTY),
    POST_INTENT = as.numeric(POST_INTENT),
    POST_LATENCY = as.numeric(POST_LATENCY),
    POST_ID_CONF = as.numeric(POST_ID_CONF),
    POST_AGE_CONF = as.numeric(POST_AGE_CONF),
    POST_GENDER_CONF = as.numeric(POST_GENDER_CONF)
  ) %>% 
...
write.csv(df_sd_questions_long_z, file = "data/output/Study_4/df_sd_questions_long_z_S4.csv", na="")
saveRDS(df_sd_questions_long_z, file = "data/output/Study_4/df_sd_questions_long_z_S4.rds")    
...
write.csv(df_graphs_abs, file = "data/output/Study_4/df_graphs_abs_S4.csv", na="")
saveRDS(df_graphs_abs, file = "data/output/Study_4/df_graphs_abs_S4.rds")
...
write.csv(df_sd_questions_long_abs, file = "data/output/Study_4/df_sd_questions_long_abs_S4.csv", na="")
saveRDS(df_sd_questions_long_abs, file = "data/output/Study_4/df_sd_questions_long_abs_S4.rds")    
