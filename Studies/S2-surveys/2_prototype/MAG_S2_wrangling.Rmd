...
for (s in stimuli){
  ...
  plots_stimulus[[i]] <- x
  ggsave(plot = x, path="figs/plots_stimulus", filename =paste(s,".png"), units = c("in"), width = 10, height = 14  )
}
...
for (c in categories){
  ...
  plots_category[[i]] <- x
  ggsave(plot = x, path="figs/plots_category", filename =paste(q,".png"), units = c("in"), width = 10, height = 26)
...
for (q in questions){
  ...
  ggsave(plot = x, path="figs/plots_s_question", filename =paste(q,".png"), units = c("in"), width = 10, height = 26)
}
...
for (q in questions){
  ...
  ggsave(plot = x, path="figs/plots_c_question", filename =paste(q,".png"))
}
