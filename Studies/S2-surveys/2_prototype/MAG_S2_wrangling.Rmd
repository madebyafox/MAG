...
df_raw_datacollar <- read_csv("data/CLEAN_MAG_S2_PROLIFIC-DATACOLLAR_B1.csv", col_names = TRUE)
df_raw_datacollar <- df_raw_datacollar[-c(1:2),]
df_raw_bluecollar <- read_csv("data/CLEAN_MAG_S2_PROLIFIC-BLUECOLLAR_B1.csv", col_names = TRUE)
...
(cont <- table(df_master$ID.Study))
(cont <- table(df_data$ID.Study))
