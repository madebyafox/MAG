...
plotsd = function (data, column, boxplot) {
...
####################CREATE SD PLOTS FOR EACH GRAPH#####################
...
x
ggsave(plot = x, path="figs/sd_by_stimuli", filename =paste(stim,".png"), units = c("in"), width = 10, height = 14  )
