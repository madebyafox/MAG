...
df_raw <- rbind(df_raw_b2, df_raw_pilot)
rm(df_raw_datacollar, df_raw_bluecollar, df_raw_b2, df_raw_pilot, x)
...
# 65c53fd727dceff9fd360b09 - data collar 
    ...
    ID.Study = factor(ID.Study, 
                      levels = c("65c53fd727dceff9fd360b09", "65ceb65b05030d95c598ef1b","65d8f06b624798854f7f6872"),
                      labels = c("datacollar","bluecollar","block2")),
...
vals <- c("block1", "block2")
leftside <- rep("left-leaning",2)
rightside <- rep("right-leaning",2)
...
p_politics <- b00_m_politics / b11_m_politics / b12_m_politics / b13_m_politics / b14_m_politics / b21_m_politics / b22_m_politics / b23_m_politics / b24_m_politics
