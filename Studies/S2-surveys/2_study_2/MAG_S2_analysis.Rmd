...
```{r, maker-id-confidence-stimulus, message=FALSE, warning=FALSE}
...
```{r maker-age-confidence-stimulus, message=FALSE, warning=FALSE}
...
```{r maker-gender-confidence-stimulus, message=FALSE, warning=FALSE}
...
```{r toolid-confidence-stimulus, message=FALSE, warning=FALSE}
