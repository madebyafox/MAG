...
## ALL SEMANTIC DIFFERENTIAL QUESTIONS
...
#FILTER DATAFRAME
s = "B0-0" #stimulus
t = "Millenial Pink Plants" #stimulus title
g = "ID.Study"
...
b13_m_design <- ggplot(df, aes(y = MAKER_DESIGN, x = Scope, color = Scope))+
  geom_jitter(width = 0.1, alpha=0.5) + 
  scale_y_continuous(limits=c(-1,101)) +
  labs(x="", y="") +
  coord_flip() + 
...
PLOT_maker <- (b13_m_design / b13_m_data / b13_m_politics / b13_m_argue / b13_m_selfish / b13_m_align / b13_m_trust) + 
  plot_annotation(
    title = t
  )
...
```{r SAMPLE-ALLQ-BY-STIMULUS-GROUPED}
