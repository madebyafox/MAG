...
right <- c("layperson","layperson", 
           ...
           "trusthworthy", "very much", "persuade", "very much")
...
ref_sd_questions_abs <- c("abs_MAKER_DESIGN","abs_MAKER_DATA",
                      "abs_MAKER_POLITIC", "abs_MAKER_ARGUE","abs_MAKER_SELF","abs_MAKER_ALIGN","abs_MAKER_TRUST",
                      "abs_CHART_TRUST", "abs_CHART_INTENT", "abs_CHART_LIKE", "abs_CHART_BEAUTY")
...
df_graphs <- df_graphs_full %>% 
  ...
  mutate(
   ...
   MAKER_AGE = factor(MAKER_AGE, levels = c("boomer","gen-x","millennial","gen-z") ) 
  )
## WRITE DATAFRAME
