...
*This notebook contains code to characterize the distribution of demographic (response) variables in the VISUALIZATION VIBES project Study #2 (survey). It relies upon data wrangling performed in `1_VIBES_S2_wrangling.Rmd`*.
