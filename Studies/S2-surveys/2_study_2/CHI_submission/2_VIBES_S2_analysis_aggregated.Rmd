...
g
ggsave(g, scale =1, filename = "figs/level_aggregated/heatmaps/full_correlation_all.png", width = 14, height = 6, dpi = 320, limitsize = FALSE)

d <- iris  # Load the traditional iris dataset into an object called df (for dataframe)
cor_results <- cor.test(d$Sepal.Length, d$Petal.Length)  #
report(cor_results)
