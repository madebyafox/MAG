...
stat_gender <- paste0(m_age$value, "(", m_gender$prop,"%)")%>%  unlist() %>% paste0(collapse=''," ")
...
if(GRAPH_SAVE){ggsave(plot = S, path="figs/level_aggregate/distributions/categoricals", filename =paste0("CAT_ACTION.png"), units = c("in"), width = 14, height = 8 ,  bg='#ffffff'  )}
S
...
if(GRAPH_SAVE){ggsave(plot = S, path="figs/level_aggregate/distributions/categoricals", filename =paste0("CAT_ACTION4.png"), units = c("in"), width = 14, height = 8 ,  bg='#ffffff'  )}
S
...
if(GRAPH_SAVE){ggsave(plot = S, path="figs/level_aggregate/distributions/categoricals", filename =paste0("CAT_ACTION3.png"), units = c("in"), width = 14, height = 8 ,  bg='#ffffff'  )}
S
...
if(GRAPH_SAVE){ggsave(plot = S, path="figs/level_aggregate/distributions/categoricals", filename =paste0("CAT_ACTION2.png"), units = c("in"), width = 14, height = 8 ,  bg='#ffffff'  )}
S
```
