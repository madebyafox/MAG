...
**In addition to the descriptive analysis of stimuli in Block 2 that is reported in the manuscript, here we create visualize the semantic differential scale for _each_ stimulus in Study 2. **

## SD questions for each stimulus

```{r plot_halfeye_sdsplot_ALL}
