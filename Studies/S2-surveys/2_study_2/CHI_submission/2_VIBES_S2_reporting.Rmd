...
#### correlation matrices — semantic differetial
...
## Do ratings of DATA COMPETENCE differ significantly as a function of MAKER ID?
ggwithinstats(data = df, 
              x = MAKER_ID, y = MAKER_DATA)
