...
## IMPORTANT 
GRAPH_SAVE = TRUE #set to true to generate all the SD graphs and save to folders (note this will overwrite existing graphs)
...
############## IMPORT DATA FILES
df_participants <- read_csv("data/input/df_participants.csv") #1 row per participant — demographic
df_graphs <- read_csv("data/input/df_graphs.csv") #only categorical and numeric questions
df_sd_questions_long <- read_csv("data/input/df_sd_questions_long.csv") # only sd questions LONG
