...
for (s in stimuli){
  ...
  (g <- d %>%
    ...
    ## MEDIAN
    stat_summary(fun=median, geom="text", fontface = "bold", size= 3,
  ...
  if(GRAPH_SAVE == TRUE){ 
    ggsave(plot = g, path="figs/PAPER", filename =paste0(s,"_ggdist.png"), units = c("in"), width = 10, height = 14,  bg='#ffffff')
  }
