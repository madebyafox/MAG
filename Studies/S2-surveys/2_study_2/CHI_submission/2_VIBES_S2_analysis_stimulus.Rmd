...
my_colors = list(
  ...
  actions4 = c("#8E8E8E", "#2A363B","#99b898ff","#e84a60ff"),
  actions3 = c("#8E8E8E","#99b898ff","#fdcea8ff"),
  actions2 = c("#8E8E8E","#99b898ff"),
...
saveRDS(corr_matrices, file = "figs/level_stimulus/correlations/MODEL_partial_correlation_by_stimulus.RDS")
