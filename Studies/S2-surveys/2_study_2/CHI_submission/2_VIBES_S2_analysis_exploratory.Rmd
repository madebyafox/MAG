...
B <- 
  ...
  ggsave(plot = B, path="figs/level_stimulus/distributions", filename =paste0("ALL_CONFIDENCE_box.png"), units = c("in"), width = 10, height = 14  )
...
R <-  df %>% 
  ...
  easy_remove_legend()
  ggsave(plot = R, path="figs/level_stimulus/distributions", filename =paste0("ALL_CONFIDENCE_ridges.png"), units = c("in"), width = 10, height = 14  )
...
G <-   ggplot(df, aes(y = fct_rev(QUESTION), x = CONFIDENCE, fill = QUESTION)) +
  ...
  theme_minimal() + easy_remove_legend()
   ggsave(plot = G, path="figs/level_stimulus/distributions", filename =paste0("ALL_CONFIDENCE_ggdist.png"), units = c("in"), width = 10, height = 14  )
...
B <- 
  ...
  ggsave(plot = B, path="figs/level_stimulus/distributions", filename =paste0("MAKER_CONF_box.png"), units = c("in"), width = 10, height = 14  )
...
## RIDGEPLOT W/ INTERVAL MEAN
 R <-  df %>% 
  ...
  labs(title = "MAKER ID CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  easy_remove_legend()
  ggsave(plot = R, path="figs/level_stimulus/distributions", filename =paste0("MAKER_CONF_ridges.png"), units = c("in"), width = 10, height = 14  )
...
G <-   ggplot(df, aes(y = STIMULUS, x = MAKER_CONF)) +
    ...
    # facet_grid(BLOCK ~ STIMULUS_CATEGORY, ) + 
      labs(title = "MAKER ID CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  theme_minimal() + easy_remove_legend()
  ggsave(plot = G, path="figs/level_stimulus/distributions", filename =paste0("MAKER_CONF_ggdist.png"), units = c("in"), width = 10, height = 14  )
...
B <- 
  ...
  ggsave(plot = B, path="figs/level_stimulus/distributions", filename =paste0("AGE_CONF_box.png"), units = c("in"), width = 10, height = 14  )
...
## RIDGEPLOT W/ INTERVAL MEAN
 R <-  df %>% 
  ...
  labs(title = "MAKER AGE CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  easy_remove_legend()
  ggsave(plot = R, path="figs/level_stimulus/distributions", filename =paste0("AGE_CONF_ridges.png"), units = c("in"), width = 10, height = 14  )
...
G <-   ggplot(df, aes(y = STIMULUS, x = AGE_CONF)) +
    ...
    # facet_grid(BLOCK ~ STIMULUS_CATEGORY, ) + 
      labs(title = "MAKER AGE CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  theme_minimal() + easy_remove_legend()
  ggsave(plot = G, path="figs/level_stimulus/distributions", filename =paste0("AGE_CONF_ggdist.png"), units = c("in"), width = 10, height = 14  )
...
B <- 
  ...
  ggsave(plot = B, path="figs/level_stimulus/distributions", filename =paste0("GENDER_CONF_box.png"), units = c("in"), width = 10, height = 14  )
...
## RIDGEPLOT W/ INTERVAL MEAN
 R <-  df %>% 
  ...
  labs(title = "MAKER GENDER CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  easy_remove_legend()
  ggsave(plot = R, path="figs/level_stimulus/distributions", filename =paste0("GENDER_CONF_ridges.png"), units = c("in"), width = 10, height = 14  )
...
G <-   ggplot(df, aes(y = STIMULUS, x = GENDER_CONF)) +
    ...
    # facet_grid(BLOCK ~ STIMULUS_CATEGORY, ) + 
      labs(title = "MAKER GENDER CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  theme_minimal() + easy_remove_legend()
  ggsave(plot = G, path="figs/level_stimulus/distributions", filename =paste0("GENDER_CONF_ggdist.png"), units = c("in"), width = 10, height = 14  )
...
B <- 
  ...
  ggsave(plot = B, path="figs/level_stimulus/distributions", filename =paste0("TOOL_CONF_box.png"), units = c("in"), width = 10, height = 14  )
...
## RIDGEPLOT W/ INTERVAL MEAN
 R <-  df %>% 
  ...
  labs(title = "TOOL ID CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  easy_remove_legend()
  ggsave(plot = R, path="figs/level_stimulus/distributions", filename =paste0("TOOL_CONF_ridges.png"), units = c("in"), width = 10, height = 14  )
...
G <-   ggplot(df, aes(y = STIMULUS, x = TOOL_CONF)) +
    ...
    # facet_grid(BLOCK ~ STIMULUS_CATEGORY, ) + 
      labs(title = "TOOL ID CONFIDENCE by STIMULUS", caption = "(mean in blue)") + 
  theme_minimal() + easy_remove_legend()
  ggsave(plot = G, path="figs/level_stimulus/distributions", filename =paste0("TOOL_CONF_ggdist.png"), units = c("in"), width = 10, height = 14  )
...
df <- df_graphs %>% select(PID, Distribution, STIMULUS,MAKER_CONF, AGE_CONF, GENDER_CONF, TOOL_CONF) %>% 
  pivot_longer(
    cols = c(MAKER_CONF, AGE_CONF, GENDER_CONF, TOOL_CONF),
    names_to = "QUESTION",
    values_to = "CONFIDENCE"
