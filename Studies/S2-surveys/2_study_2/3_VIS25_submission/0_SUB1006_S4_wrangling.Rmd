...
*This notebook contains code to wrangle raw data from a qualtrics survey into a single normalized dataset of (valid) participant responses.*

# WRANGLING

This file takes a raw data files from (1) Qualtrics surveys (Study 4), standardizing the format for further data analysis consistent with the data structures for Studies 1-3. Note that all raw data comes from Qualtrics, and each Qualtrics survey includes a different stimulus block (set of 5 stimuli).
...
Here we drop irrelevant columns (qualtrics junk) and set factors
...
write.csv(df_exclude, file = "data/output/df_exclude_S4.csv", na="")
saveRDS(df_exclude, file = "data/output/df_exclude_S4.rds")
...
*Primarily used for manual text analysis; columns not factorized*
...
write.csv(df_participants, file = "data/output/df_participants_S4.csv", na="")
saveRDS(df_participants, file = "data/output/df_participants_S4.rds")


```


## Create WIDE Response File
...
write.csv(df_data, file = "data/output/df_data_S4.csv", na="")
saveRDS(df_data, file = "data/output/df_data_S4.rds")
...
## 1 ROW / PARTICIPANT 
df_qda_wide <- df_data
write.csv(df_data, file = "data/output/df_qda_wide_S4.csv", na="")
...
write.csv(df_qda_long, file = "data/output/df_qda_long_S4.csv", na="")
...
# WRANGLE DATA FOR ANALYSIS FILES
...
## WRITE DATAFRAME
write.csv(df_questions_long, file = "data/output/df_questions_long_S4.csv", na="")
saveRDS(df_questions_long, file = "data/output/df_questions_long_S4.rds")
...
## WRITE DATAFRAME
write.csv(df_questions, file = "data/output/df_questions_S4.csv", na="")
saveRDS(df_questions, file = "data/output/df_questions_S4.rds")
...
## WRITE DATAFRAME
write.csv(df_sd_questions_wide, file = "data/output/df_sd_questions_wide_S4.csv", na="")
saveRDS(df_sd_questions_wide, file = "data/output/df_sd_questions_wide_S4.rds")
...
#   filter(QUESTION %in% ref_sd_questions) 
# ## WRITE DATAFRAME
# write.csv(df_sd_questions_long, file = "data/output/df_sd_questions_long_S4.csv", na="")
# saveRDS(df_sd_questions_long, file = "data/output/df_sd_questions_long_S4.rds")
```

### Stimulus Level (i.e. Trial Level)
```{r WRANGLE-STIMULUS-LEVEL}
...
## WRITE DATAFRAME
write.csv(df_graphs_full, file = "data/output/df_graphs_full_S4.csv", na="")
saveRDS(df_graphs_full, file = "data/output/df_graphs_full_S4.rds")
...
## WRITE DATAFRAME
write.csv(df_graphs, file = "data/output/df_graphs_S4.csv", na="")
saveRDS(df_graphs, file = "data/output/df_graphs_S4.rds")
...
write.csv(df_graphs_z, file = "data/output/df_graphs_z_S4.csv", na="")
saveRDS(df_graphs_z, file = "data/output/df_graphs_z_S4.rds")
...
write.csv(df_graphs_abs, file = "data/output/df_graphs_abs_S4.csv", na="")
saveRDS(df_graphs_abs, file = "data/output/df_graphs_abs_S4.rds")
