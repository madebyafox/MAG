...
NOTE: data from PILOT (i.e. 'blue collar' and 'data collar' runs on Prolific) are *included* in the qualitative data analysis (i.e. analysis of free response data) but *not* in quantitative data analysis (modelling as well as reporting descriptive statistics of response distributions. --> CHANGE THEY'VE BEEN LEFT IN FOR COMPARISON W/ TUMBLR
...
df_data <- df_data %>% 
  mutate(
    ...
    Distribution = factor(Distribution, levels=order_study), ## ADDED FACTOR ORDER TO KEEP TUBMLR AS FIRST 
