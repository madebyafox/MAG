...
_There is substantial variance in choice of social media platform across the sample (S1 & S2 combined), though the relative distribution across randomly assigned stimulus blocks within each sample is roughly uniform, and thus comparable. (S1) Tumblr chose (1) Tumblr, (2) Instagram or (3) Facebook, while (S2) Prolific chose (1) Instagram, (2) Facebook, (3) Twitter/X, followed by small number of Tumblr & LinkedIn._
