...
Participants were sampled from two survey distribution sources: (STUDY 1) direct solicitation from co-author MM's ethnographic research participants on Tumblr, (STUDY 2)two samples of US-BASED English Speaking participants on Prolific with targeted occupations (`data collar`, `blue-collar`) and finally (STUDY 3) a  general sample of US-BASED, English-speaking participants on PROLIFIC (no demographic targetting). 
